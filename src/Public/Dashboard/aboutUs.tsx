...
export function AboutUs() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-100 dark:bg-gray-900 py-24 sm:py-32 h-[calc(64vh-4rem)] sm:h-[calc(50vh-4rem)] min-h-[64rem] sm:min-h-[50rem] transition-colors duration-300">
